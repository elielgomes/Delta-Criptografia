...
printf("<div id='carouselExampleFade' class='carousel slide carousel-fade' data-bs-ride='carousel'>");
    printf("<div class='carousel-inner'>");
      printf("<div class='carousel-item active'>");
        printf("<img src='https://user-images.githubusercontent.com/108281436/197296421-db797a88-aceb-4158-b3e9-74e5fdc2d8b3.png' class='d-block w-100' alt='...'>");
     printf("</div>");
      printf("<div class='carousel-item'>");
        printf("<img src='https://user-images.githubusercontent.com/108281436/197296446-1c1cac8e-090a-4d54-87d1-4f6052b78a09.png' class='d-block w-100' alt='...'>");
      printf("</div>");
    printf("</div>");
