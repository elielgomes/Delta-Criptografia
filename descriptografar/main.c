...
printf("<input id='btn-criptografar' type='submit' value='DESCRIPTOGRAFAR'>");
printf("</form>");
printf("</main>");
...
printf("<h1>MENSAGEM DESCRIPTOGRAFADA</h1>");
...
printf("<script>");
    ...
    printf("function verifica(){ \n");
            ...
            printf("aElement.href='/cgi-bin/descriptografar/main.exe' \n");
